                                                ...
                                                @foreach ($locales as $key => $locale)
                                                    <div class="tab-pane fade {{ $loop->first ? 'active show' : '' }}"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"
                                                                value="{{ old('title' . $key, $definition->getTranslation('title', $key)) }}"
                                                                class="form-control" name="title[{{ $key }}]" id="exampleInputEmail1"
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea placeholder="Enter Description" id="summernote-{{ $key }}" name="desc[{{ $key }}]"
                                                                    class="mt-3 mb-3">{{ old('desc' . $key, $definition->getTranslation('desc', $key)) }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
