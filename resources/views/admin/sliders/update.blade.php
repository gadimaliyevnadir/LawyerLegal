                            ...
                            <div class="row">
                                                    ...
                                                    <div class="tab-pane fade {{ $loop->first ? 'active show' : '' }}"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea placeholder="Enter Title" id="editor" name="title[{{ $key }}]" class="mt-3 mb-3">{{ old('title' . $key, $slider->getTranslation('title', $key)) }}</textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="mb-1">Subtitle</label>
                                                                <textarea placeholder="Enter Subtitle" id="summernote-{{ $key }}" name="subtitle[{{ $key }}]"
                                                                    class="mt-3 mb-3">{{ old('subtitle' . $key, $slider->getTranslation('subtitle', $key)) }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <img class="img-fluid" style="height: 390px" src="{{ asset('storage/' . $slider->image) }}">
                                        </div>
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" value="{{ old('image', $slider->image) }}"
