       ...
       <div class="row w-100">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('admin.rightaligned.update', $rightaligned->id) }}" method="post"
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea placeholder="Enter Description" id="summernote-{{ $key }}" name="desc[{{ $key }}]"
                                                                    class="mt-3 mb-3">{{ old('desc' . $key, $rightaligned->getTranslation('desc', $key)) }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <img class="img-fluid" style="height: 390px"
                                                src="{{ asset('storage/' . $rightaligned->image) }}">
                                        </div>
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" value="{{ old('image', $rightaligned->image) }}"
