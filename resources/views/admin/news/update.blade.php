                                                    ...
                                                    <div class="tab-pane fade {{ $loop->first ? 'active show' : '' }}"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea placeholder="Enter Title" id="editor" name="title[{{ $key }}]" class="mt-3 mb-3">{{ old('title' . $key, $news->getTranslation('title', $key)) }}</textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="mb-1">Description</label>
                                                                <textarea placeholder="Enter Description" id="summernote-{{ $key }}" name="desc[{{ $key }}]"
                                                                    class="mt-3 mb-3">{{ old('desc' . $key, $news->getTranslation('desc', $key)) }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" value="{{ old('image', $news->image) }}"
